...
<!DOCTYPE html>
  <head>
    ...
    <?php print $styles; ?>
    <?php print $scripts; ?>
    <link href="https://fonts.googleapis.com/css?family=Merriweather:300,300i,900,900i|Montserrat:700" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', 'clayingels'); ?>/htmlshim/dist/html5shiv.js"></script>
    <![endif]-->
  </head>
